...
class class_Room(baseApi):
	...
	def search_classRoom(self,roomName):
		...
		data = {
			"method": "post",
			"url": "https://"+self.set_url()+"/web/api/v1/classRoom/list",
			"headers":{
	...
	def save_classRoom(self,roomName):
		data = {
			"method": "post",
			"url": "https://" + self.set_url() + "/web/api/v1/classRoom/save",
			"headers": {
				"Access-Token": self.token,
				"user-agent": "3333"
			},
	...
	def update_classRoom(self,roomName,id):
		data = {
			"method": "post",
			"url": "https://" + self.set_url() + "/web/api/v1/classRoom/update",
			"headers": {
				"Access-Token": self.token,
				"user-agent": "3333"
			},
	...
	def delete_classRoom(self,id):
		data = {
			"method": "get",
			"url": "https://" + self.set_url() + "/web/api/v1/classRoom/del?id="+id,
			"headers": {
				"Access-Token": self.token,
				"user-agent": "3333"
			}
